...
public:	
	...
	*****************************/
	...
	FText RangedWeaponNameText;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon Info")
	FText RangedWeaponDescriptionText;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon Info")
	FText RangedWeaponTypeText;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon Info")
	FText RangedWeaponRarityText;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Weapon Info")
	float RangedWeaponDamageText;
...
public:
	...
	FORCEINLINE FText GetRangedWeaponNameText() const { return RangedWeaponNameText; }
	FORCEINLINE FText GetRangedWeaponDescriptionText() const { return RangedWeaponDescriptionText; }
	FText GetRangedWeaponTypeText();
	FORCEINLINE FText GetRangedWeaponRarityText() const { return RangedWeaponRarityText; }
	FORCEINLINE float GetRangedWeaponDamageText() const { return RangedWeaponDamageText; }
