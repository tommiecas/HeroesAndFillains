...
UCLASS()
class HEROESANDFILLAINS_API APointCollection : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	TArray<USceneComponent*> GetGroundPoints(const FVector& GroundLocation, int32 NumberOfPoints, float YawOverride = 0.f);
