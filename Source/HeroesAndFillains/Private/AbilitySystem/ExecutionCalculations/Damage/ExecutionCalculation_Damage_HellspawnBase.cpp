...
#include "AbilitySystem/ExecutionCalculations/ExecutionCalculation_Damage_HellspawnBase.h"
...
UExecutionCalculation_Damage_HellspawnBase::UExecutionCalculation_Damage_HellspawnBase()
{
...
void UExecutionCalculation_Damage_HellspawnBase::DetermineDebuff(const FGameplayEffectCustomExecutionParameters& ExecutionParams, const FGameplayEffectSpec& Spec, FAggregatorEvaluateParameters EvaluationParameters, const TMap<FGameplayTag, FGameplayEffectAttributeCaptureDefinition>& InTagsToCaptureDefs) const
{
...
void UExecutionCalculation_Damage_HellspawnBase::Execute_Implementation(
