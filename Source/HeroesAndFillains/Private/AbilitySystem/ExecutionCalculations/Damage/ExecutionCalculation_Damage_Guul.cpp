...
#include "AbilitySystem/ExecutionCalculations/ExecutionCalculation_Damage_Guul.h"
...
UExecutionCalculation_Damage_Guul::UExecutionCalculation_Damage_Guul()
{
...
void UExecutionCalculation_Damage_Guul::DetermineDebuff(const FGameplayEffectCustomExecutionParameters& ExecutionParams, const FGameplayEffectSpec& Spec, FAggregatorEvaluateParameters EvaluationParameters, const TMap<FGameplayTag, FGameplayEffectAttributeCaptureDefinition>& InTagsToCaptureDefs) const
{
...
void UExecutionCalculation_Damage_Guul::Execute_Implementation(
